...
#define TASK_POWER_MUX_MON_PRIO         tskIDLE_PRIORITY + 2
#define TASK_SUPP_CHARGING_PRIO         tskIDLE_PRIORITY + 3
...
#define TASK_SUPP_CHARGING_STACK_SIZE                   configMINIMAL_STACK_SIZE
...
extern StackType_t Task_FaultState_Stack_Array[ TASK_FAULT_STATE_STACK_SIZE ];
extern StackType_t Task_SuppCharger_Stack_Array[ TASK_SUPP_CHARGING_STACK_SIZE ];


// Task Buffers
extern StaticTask_t Task_SuppMon_Buffer;
extern StaticTask_t Task_PowerMux_Buffer;
extern StaticTask_t Task_FaultState_Buffer;
extern StaticTask_t Task_SuppCharger_Buffer;
...
// Task delays
#define SUPPLEMENTAL_MONITOR_THREAD_DELAY_TICKS pdMS_TO_TICKS(500)
#define SUPPLEMENTAL_CHARGER_THREAD_DELAY_TICKS pdMS_TO_TICKS(1000)  
#define POWER_MUX_MONITOR_THREAD_DELAY_TICKS    pdMS_TO_TICKS(5000)